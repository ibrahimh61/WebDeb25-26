...
function avg{
let g1 = parceFloat(document.getElementById("g1")).value;
let g2 = parceFloat(document.getElementById("g2")).value;
let g3 = parceFloat(document.getElementById("g2")).value;
